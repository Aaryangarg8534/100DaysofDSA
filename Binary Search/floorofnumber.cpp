//floor means greatest smaller  number like we given a number so we need to find a number  
//which is just before smallest number or equal to given number
